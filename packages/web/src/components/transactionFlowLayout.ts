...
const TRANSACTION_FLOW_COLUMN_WIDTH = 190;
const TRANSACTION_FLOW_LEFT_MARGIN = 120;
const TRANSACTION_FLOW_TOP_MARGIN = 105;
export const TRANSACTION_FLOW_ROW_HEIGHT = 72;
const TRANSACTION_FLOW_COLUMN_NODE_WIDTH = 144;
const TRANSACTION_FLOW_COLUMN_NODE_HEIGHT = 58;
