...
const NOTEBOOK_ASSISTANT_TOOL_REGISTRY = [
  ...
  { name: "createUpdateChartOptionsPatch", kind: "patch", args: "{ chartId: string, axisMode?: 'shared' | 'separate', compareMode?: 'levels' | 'relative' | 'percent', niceScale?: boolean, referenceTrace?: ReferenceTrace, showScenarioShocks?: boolean | 'auto', seriesRanges?: object, sharedRange?: object, timeRangeInclusive?: [integer, integer], yAxisTickCount?: integer }" },
